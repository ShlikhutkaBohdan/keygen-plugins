...
def test_get_address_d0():
    address = DenariusCoinService().get_address('QSDoM1x6bu7BJH965SEu2GrGZdqXbjfBrjDYxfmfvkGYX7aCAPvX')
    assert 'DPNsvdVer4LPjPApt8hw4sFfwRfb7ihAHj' == address


def test_get_address_d1():
    address = DenariusCoinService().get_address('QWHQY5iNj5HbS9M25yb2UVm8Lh8aqfJUuqbJ4NhkHQqLcczqL6Qd')
